...
#define max_sample_rate 200   // 100 or 200 appears to be fine

// Bit clearing and setting variables
#ifndef cbi
...
int sampleRate = 100;           // App sample rate in Hz 
int startFreq = 50;             // AC start frequency in kHz
int stepSize = 0;               // Step size of AC frequency sweep in kHz
...
// ================================================================
  ...
  Serial.println("Welcome! Please note the following:"); Serial.println(); Serial.print(1, DEC);
  Serial.println("\tAll AC frequencies are in kilohertz."); Serial.print(2, DEC);
  Serial.println("\tSample rate frequency is in hertz."); Serial.print(3, DEC);
  Serial.println("\tFor frequency sweeps, it is necessary to pad all values with zero to make up 3 bytes each."); Serial.print(4, DEC);
  Serial.println("\tTo turn off frequency sweeps, supply the step size with 0 (3 zeros)."); Serial.print(5, DEC);
  Serial.println("\tInput is comma delimited with no spaces."); Serial.println();
  
  Serial.println("\tPlease use the following syntax to input commands:"); Serial.println(); Serial.print(1, DEC);
  Serial.println("\tb - begin sampling."); Serial.print(2, DEC);
  Serial.println("\ts - stop sampling"); Serial.print(3, DEC);
  Serial.println("\tr,samplerate  - change sample rate."); Serial.print(4, DEC);
...
void loop(){
  ...
  // This whole thing can likely just be made into a function for future use
